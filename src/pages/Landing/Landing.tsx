...
import { ReactComponent as MadePossible } from '../../assets/svg/img-made-possible.svg';
      ...
      <Content>
        ...
        <div className='cards-container'>
            <div className='card'>
              ...
              <h3><b>One Link</b> to rule them all</h3>
            ...
            <div className='card circles'>
              ...
              <h3><b>Circles</b> is coming back!</h3>
            ...
            <div className='card'>
              ...
              <h3>Censorship<b> proof</b></h3>
              <p>You are the captain of this ship.<br></br>
              Your data, your terms.<br></br>
              All, Powered by Ethereum.</p>
            </div>
          </div>
          <div className='links-section'>
            <div className='links-categories'>
              <span className='link-category-label active'>All</span>
              <span className='link-category-label'>Web3</span>
              <span className='link-category-label'>Creators</span>
              <span className='link-category-label'>Organisations</span>
            </div>
            <h2><b>All</b> your links & Content in <b>one place</b></h2>
          ...
          <footer>
            ...
            <div className='social-icons'>
              <a href='https://twitter.com/0xNimi' target="_blank"><IconTwitterNimi /></a>
              <a href='https://discord.com/invite/ZcyJa7MJZR' target="_blank"><IconDiscordNimi /></a>
              <a href='https://github.com/nimi-app' target="_blank"><IconGithubNimi /></a>
            </div>
          </footer>
      </Content>
    </PageWrapper>
