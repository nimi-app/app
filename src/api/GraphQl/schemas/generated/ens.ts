...
export type GetDomainsOwnedOrControlledByQuery = { __typename?: 'Query', account?: { __typename?: 'Account', domainsOwned: Array<{ __typename?: 'Domain', id: string, labelName?: string | null, labelhash?: any | null, name?: string | null, isMigrated: boolean, parent?: { __typename?: 'Domain', name?: string | null, id: string } | null }>, wrappedDomainsOwned?: Array<{ __typename?: 'WrappedDomain', id: string, name?: string | null, domain: { __typename?: 'Domain', id: string, labelName?: string | null, labelhash?: any | null, name?: string | null, isMigrated: boolean, parent?: { __typename?: 'Domain', name?: string | null, id: string } | null }, owner: { __typename?: 'Account', id: string } }> | null } | null, domainsControlled: Array<{ __typename?: 'Domain', id: string, labelName?: string | null, labelhash?: any | null, name?: string | null, isMigrated: boolean, parent?: { __typename?: 'Domain', name?: string | null, id: string } | null }>, wrappedDomainsControlled: Array<{ __typename?: 'WrappedDomain', id: string, name?: string | null, domain: { __typename?: 'Domain', id: string, labelName?: string | null, labelhash?: any | null, name?: string | null, isMigrated: boolean, parent?: { __typename?: 'Domain', name?: string | null, id: string } | null }, owner: { __typename?: 'Account', id: string } }> };
...
export type DomainFieldsFragment = { __typename?: 'Domain', id: string, labelName?: string | null, labelhash?: any | null, name?: string | null, isMigrated: boolean, parent?: { __typename?: 'Domain', name?: string | null, id: string } | null };

export type WrappedDomainFieldsFragment = { __typename?: 'WrappedDomain', id: string, name?: string | null, domain: { __typename?: 'Domain', id: string, labelName?: string | null, labelhash?: any | null, name?: string | null, isMigrated: boolean, parent?: { __typename?: 'Domain', name?: string | null, id: string } | null }, owner: { __typename?: 'Account', id: string } };

export type GetAccountNamesQueryVariables = Exact<{
  id: Scalars['ID'];
  chainId?: InputMaybe<Scalars['Int']>;
}>;


export type GetAccountNamesQuery = { __typename?: 'Query', account?: { __typename?: 'Account', registrations?: Array<{ __typename?: 'Registration', domain: { __typename?: 'Domain', id: string, labelName?: string | null, labelhash?: any | null, name?: string | null, isMigrated: boolean, parent?: { __typename?: 'Domain', name?: string | null, id: string } | null } }> | null, domainsControlled: Array<{ __typename?: 'Domain', id: string, labelName?: string | null, labelhash?: any | null, name?: string | null, isMigrated: boolean, parent?: { __typename?: 'Domain', name?: string | null, id: string } | null }>, wrappedDomainsControlled?: Array<{ __typename?: 'WrappedDomain', id: string, name?: string | null, domain: { __typename?: 'Domain', id: string, labelName?: string | null, labelhash?: any | null, name?: string | null, isMigrated: boolean, parent?: { __typename?: 'Domain', name?: string | null, id: string } | null }, owner: { __typename?: 'Account', id: string } }> | null } | null };
...
export const GetAccountNamesDocument = `
  ...
  account(id: $id) {
    ...
    ${DomainFieldsFragmentDoc}
${WrappedDomainFieldsFragmentDoc}`;
export const useGetAccountNamesQuery = <
      TData = GetAccountNamesQuery,
      TError = unknown
    >(
      client: GraphQLClient,
      variables: GetAccountNamesQueryVariables,
      options?: UseQueryOptions<GetAccountNamesQuery, TError, TData>,
      headers?: RequestInit['headers']
    ) =>
    useQuery<GetAccountNamesQuery, TError, TData>(
      ['getAccountNames', variables],
      fetcher<GetAccountNamesQuery, GetAccountNamesQueryVariables>(client, GetAccountNamesDocument, variables, headers),
      options
    );

useGetAccountNamesQuery.getKey = (variables: GetAccountNamesQueryVariables) => ['getAccountNames', variables];
;

export const useInfiniteGetAccountNamesQuery = <
      TData = GetAccountNamesQuery,
      TError = unknown
    >(
      pageParamKey: keyof GetAccountNamesQueryVariables,
      client: GraphQLClient,
      variables: GetAccountNamesQueryVariables,
      options?: UseInfiniteQueryOptions<GetAccountNamesQuery, TError, TData>,
      headers?: RequestInit['headers']
    ) =>
    useInfiniteQuery<GetAccountNamesQuery, TError, TData>(
      ['getAccountNames.infinite', variables],
      (metaData) => fetcher<GetAccountNamesQuery, GetAccountNamesQueryVariables>(client, GetAccountNamesDocument, {...variables, ...(metaData.pageParam ? {[pageParamKey]: metaData.pageParam} : {})}, headers)(),
      options
    );


useInfiniteGetAccountNamesQuery.getKey = (variables: GetAccountNamesQueryVariables) => ['getAccountNames.infinite', variables];
;

useGetAccountNamesQuery.fetcher = (client: GraphQLClient, variables: GetAccountNamesQueryVariables, headers?: RequestInit['headers']) => fetcher<GetAccountNamesQuery, GetAccountNamesQueryVariables>(client, GetAccountNamesDocument, variables, headers);