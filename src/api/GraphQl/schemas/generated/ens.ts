...
export const GetSubdomainsDocument = `
  ...
  domain(id: $domainId) {
    ...
    `;
export const useGetSubdomainsQuery = <
      TData = GetSubdomainsQuery,
      TError = unknown
    >(
      dataSource: { endpoint: string, fetchParams?: RequestInit },
      variables: GetSubdomainsQueryVariables,
      options?: UseQueryOptions<GetSubdomainsQuery, TError, TData>
    ) =>
    useQuery<GetSubdomainsQuery, TError, TData>(
      ['getSubdomains', variables],
      fetcher<GetSubdomainsQuery, GetSubdomainsQueryVariables>(dataSource.endpoint, dataSource.fetchParams || {}, GetSubdomainsDocument, variables),
      options
    );
export const GetDomainsOwnedOrControlledByDocument = `
    query getDomainsOwnedOrControlledBy($addressID: ID!, $addressString: String!, $searchString: String, $first: Int, $skip: Int, $orderBy: Domain_orderBy) {
...
export const useGetDomainsOwnedOrControlledByQuery = <
    ...
    useQuery<GetDomainsOwnedOrControlledByQuery, TError, TData>(
      ...
      fetcher<GetDomainsOwnedOrControlledByQuery, GetDomainsOwnedOrControlledByQueryVariables>(dataSource.endpoint, dataSource.fetchParams || {}, GetDomainsOwnedOrControlledByDocument, variables),
      options
    );
...
export const useGetDomainFromSubgraphQuery = <
    ...
    useQuery<GetDomainFromSubgraphQuery, TError, TData>(
      ...
      fetcher<GetDomainFromSubgraphQuery, GetDomainFromSubgraphQueryVariables>(dataSource.endpoint, dataSource.fetchParams || {}, GetDomainFromSubgraphDocument, variables),
      options
    );