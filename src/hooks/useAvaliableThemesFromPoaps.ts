...
const themeToPoapMapping: { theme: NimiCuratedTheme; eventId: number[] }[] = [
  ...
  { theme: NimiThemeType.DAIVINITY, eventId: [74051] },
  {
    ...
    eventId: [
      98806, 98810, 98812, 98813, 99047, 98815, 98818, 99044, 99608, 99923, 98823, 98826, 99610, 98827, 99348, 99614,
      99850, 97863, 98828, 98829, 98830, 98831, 98835, 99616, 98837, 98838, 98839, 99851,
    ],
  },
  { theme: NimiThemeType.ETH_PRAGUE_2023, eventId: [1234] },
];
