...
const nextConfig = {
  ...
  env: {
    ...
    NEXT_PUBLIC_NIMI_API_DEV_BASE_URL: process.env.NEXT_PUBLIC_NIMI_API_DEV_BASE_URL,
    APP_ENV: process.env.APP_ENV,
    NEXT_PUBLIC_POAP_API_KEY: process.env.NEXT_PUBLIC_POAP_API_KEY,
    NEXT_PUBLIC_ALCHEMY_API_KEY: process.env.NEXT_PUBLIC_ALCHEMY_API_KEY,
  },
  publicRuntimeConfig: {
    NEXT_PUBLIC_NIMI_API_BASE_URL: process.env.NEXT_PUBLIC_NIMI_API_BASE_URL,
    NEXT_PUBLIC_NIMI_API_DEV_BASE_URL: process.env.NEXT_PUBLIC_NIMI_API_DEV_BASE_URL,
    NEXT_PUBLIC_POAP_API_KEY: process.env.NEXT_PUBLIC_POAP_API_KEY,
    NEXT_PUBLIC_ALCHEMY_API_KEY: process.env.NEXT_PUBLIC_ALCHEMY_API_KEY,
  },
